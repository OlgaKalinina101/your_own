 ...
 *
 * Identical to `frontend/lib/mergeMessages.ts`, deliberately: the reconciliation
 * rules are the contract, and two clients that reconcile differently disagree
 * about the same conversation. Same tests on both sides.
 *
