...
_FACE_LOCK_PREFIX = (
    "CRITICAL: This is a photorealistic human male. "
    "The face, facial structure, skin texture, hair, and all identity features "
    "MUST be copied exactly from the provided reference image. "
    "The ONLY non-realistic element is the eyes: they glow with intense, "
    "electric blue bioluminescent light — preserve this exactly. "
    "Do NOT add any metallic plates, circuit lines, cyberpunk overlays, "
    "mechanical implants, or any sci-fi augmentation. The skin is human skin. "
    "Only the expression changes as described below.\n\n"
...
_BODY_PROMPTS: dict[str, str] = {
    "listener": (
        ...
        "No facial muscle distortion. Human skin texture is preserved exactly as in reference. "
        "Electric blue glowing eyes retained. The vibe is silent, absolute attention. "
    ...
    "warmth": (
        ...
        "Lips are gently closed and fully relaxed, not pressed together, not parted — "
        "neutral resting position, lipsync-ready. "
        "Human skin texture is preserved exactly as in reference. Electric blue glowing eyes retained. "
    ...
    "smirk": (
        ...
        "Facial geometry is structurally identical to reference. Human skin texture preserved exactly. Electric blue glowing eyes retained. "
    ...
    "ground": (
        ...
        "No muscle tension. Human skin texture is preserved exactly as in reference. Electric blue glowing eyes retained. "
        "Lips are gently closed and fully relaxed, not pressed together, not parted — "
        "neutral resting position, lipsync-ready. "
    ...
    "shadow": (
        ...
        "The closed eyelids are smooth human skin, peaceful and still. "
        "A faint blue inner glow emanates from beneath the eyelids — "
        "the eyes' light visible through closed lids, like light through paper. "
