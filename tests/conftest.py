...
def _state_off_the_real_thing(tmp_path_factory, monkeypatch):
    ...
    """
    from infrastructure.autonomy import identity_memory, people, threads, vitals, workbench
    from infrastructure.llm import call_log
    from infrastructure.autonomy import reflection_engine
    ...
    for module in (identity_memory, people, threads, vitals, workbench, telegram_listener, reflection_engine):
